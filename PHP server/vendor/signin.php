 ...
 */
const CLIENT_ID = '70912749336-vu6u8hkruv0jiie412ni9t5elm6ba688.apps.googleusercontent.com';

/**
 * Replace this with the client secret you got from the Google APIs console.
 */
const CLIENT_SECRET = 'M-e7UTOVbZ7boksqL_gxO2VK';

/**
 * Optionally replace this with your application's name.
 */
const APPLICATION_NAME = "Spartanrides.me";

$client = new Google_Client();
$client->setApplicationName(APPLICATION_NAME);
$client->setClientId(CLIENT_ID);
$client->setClientSecret(CLIENT_SECRET);
$client->setRedirectUri('https://spartanrides.me/riders/');
...
$app->post('/connect', function (Request $request) use ($app, $client) {
	...
	header('Location: https://spartanrides.me/riders/');
